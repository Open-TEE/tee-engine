...
TEE_Result ecdsa_sign()
{
	return 0;
}

TEE_Result ecdsa_ver()
{
	return 0;
}
...
/* NOTE: useless? */
static void dup_ec_key(TEE_OperationHandle dstOperation, TEE_OperationHandle srcOperation)
{
	EC_KEY_copy(dstOperation, srcOperation);
	return;
}
