...
/* For enabling seccomp:
 *      -sudo apt-get install seccomp
 *      -compile open-tee -DHAVE_SECCOMP(remove comments from common.qbs, launcher.qbs, manager.qbs)
 *      -use gcc flag -lseccomp(remove comment from common.qbs)
 *      -TODO: Autotool makefile
