...
struct list_head storage_element_head;
					...
					uint32_t flags, TEE_ObjectHandle *object)
{
	...
	if (IS_VALID_STORAGE_BLOB(storage_blob_id)) {
		...
		existing_flags = current_element->flags;
