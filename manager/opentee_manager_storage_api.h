...
//TEE_Result MGR_TEE_ReadObjectData(TEE_ObjectHandle object, void *buffer, size_t size, uint32_t *count);
...
TEE_Result MGR_TEE_WriteObjectData(void *objectID,uint32_t objectIDLen, void *buffer, size_t size);
